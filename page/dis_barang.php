				...
				<div class="data-tables datatable-dark">
					<table class="table table-bordered" id="tbl" style="width: 100%;">
							...
							<tr>
								...
								<td><?= $row['potongan'] ?></td>
								<td>
									<a href="index.php?page=dis_barang_edit&id=<?= $row['id'] ?>"><i class="far fa-edit"></i></a> |
									<a href="index.php?page=dis_barang_hapus&id=<?= $row['id'] ?>" onclick="return confirm('apakah anda yakin?')">
