...
if (isset($_POST['simpan'])) {
	...
	echo "<script>window.location.href='kasir.php?page2=barang_add';</script>";
...
<div class="container">
	<div class="page-box">
		<form method="post">
			...
			<a href="?page2=barang" style="text-decoration: none;" class="btn btn-warning text-a">Kembali</a>
		</form>
	</div>
</div>
